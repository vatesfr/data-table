...
// needs "umd" (so `@vates/data-table-vanilla` still works as a plain <script> global), so this
// entry only ships "es"/"cjs", matching every other adapter package's own sub-path exports
