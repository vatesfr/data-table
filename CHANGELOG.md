...
- `@vates/data-table-core` — framework-agnostic pure-TypeScript logic: sorting, filtering, grouping, column visibility
...
- i18n via `labels` prop (defaults to English); all UI strings and pluralization functions are overridable
