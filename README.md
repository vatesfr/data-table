...
- Multi-column sort
- Value checklist filters (with per-column search-to-narrow and select-all), numeric range filters, and a Year/Month/Day tree filter for date columns
- Column visibility toggle and reordering (drag headers, or ▲▼ buttons in the Columns panel)
